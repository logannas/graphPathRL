...
class PathFinder(object):
    ...
    def __init__(self,graph):
        ...
        print(self.adjacent_mat)


    def q_learning(self,start_state,aim_state, fire, num_epoch=200, gamma=0.8, epsilon=0.05, alpha=0.1):
        len_of_paths = []
...
if __name__ == '__main__':
    ...
    for idx, item in enumerate(S):
        if item == 1:
            start_state = idx
            res = rl.q_learning(start_state, aim_state, fire)
            print(f"For people in {idx} the path is: ",res)